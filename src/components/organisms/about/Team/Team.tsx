...
import { AboutUsTeamSection } from "@services/types/about-us-page.types";
import Image from "next/image";

const Team = ({ data }: { data: AboutUsTeamSection }) => {
    return (
        <>
            <XContainer className="pb-8 pt-24">
                <h3 className="header-3 mb-8">{data.data.title}</h3>
                <div className="paragraph-2 maxW-[465px]">{data.data.description}</div>
            </XContainer>
                                    ...
                                    <div className="p-6 opacity-0 flex h-full flex-col lg:group-hover:opacity-100 max-lg:opacity-100 transition-opacity duration-500 delay-200">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <a
                                                ...
                                                href={item.social.find((social) => social.name === "facebook")?.url}
                                            >
                                                <svg
                                                    width="18"
                                                    height="18"
                                            ...
                                            <a
                                                target="_blank"
                                                className="bg-smoke size-9 rounded-full hover:bg-sand grid place-items-center transition-colors"
                                                href={item.social.find((social) => social.name === "instagram")?.url}
                                            >
                                                <svg
                                                    width="18"
                                                    height="18"
                                            ...
                                            <a
                                                target="_blank"
                                                className="bg-smoke size-9 rounded-full hover:bg-sand grid place-items-center transition-colors"
                                                href={item.social.find((social) => social.name === "linkedin")?.url}
                                            >
                                                <svg
                                                    width="18"
                                                    height="18"
                                            ...
                                            <a
                                                target="_blank"
                                                className="bg-smoke size-9 rounded-full hover:bg-sand grid place-items-center transition-colors"
                                                href={item.social.find((social) => social.name === "mail")?.url}
                                            >
                                                <svg
                                                    width="18"
                                                    height="18"
