...
import { DigitalInfrastructureSection } from "@services/types/solutions-page.types";
import Image from "next/image";
import { useEffect, useRef } from "react";

const Portfolio = ({ data }: { data: DigitalInfrastructureSection }) => {
                    ...
                    <div className="grid xl:grid-cols-4 grid-cols-1 xl:divide-x divide-y divide-gray">
                        {data.data.variants.map((item, index) => (
                            ...
                            >
                                ...
                                <Image
                                    className="xl:size-24 size-16 object-contain"
                                    src={item.image_url}
                                    alt={item.title}
                                    width={96}
                                    height={96}
